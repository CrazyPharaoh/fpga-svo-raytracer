`timescale 1ns/1ps
// axis_upscale_2x.sv
// Nearest-neighbour 2x upscaler for an AXI4-Stream video frame.
// In : IN_W x IN_H, 32-bit/pixel, tuser=SOF, tlast=EOL.
// Out: 2*IN_W x 2*IN_H, same format, framing regenerated. One clock domain.
// Each source pixel becomes a 2x2 block. Assumes the input delivers exactly
// IN_W*IN_H pixels/frame (true for VDMA MM2S), starting aligned after reset.
